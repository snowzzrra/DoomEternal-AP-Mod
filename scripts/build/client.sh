...
x86_64-w64-mingw32-g++ -D_M_AMD64 -std=c++17 -O2 -I. \
    native/client/ap_client_exe.cpp native/client/command_queue.cpp native/client/ap_client_path_utils.cpp native/client/game_state_probe.cpp native/client/ap_runtime_rpc_client.cpp native/client/ap_rpc_health_state.cpp native/client/ammo_hotkey.cpp \
