...
const meathook_interface_MIDL_PROC_FORMAT_STRING meathook_interface__MIDL_ProcFormatString =
    {
        0,
        {
...
const meathook_interface_MIDL_TYPE_FORMAT_STRING meathook_interface__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
const MIDL_STUB_DESC meathook_interface_StubDesc = 
    {
