...
DELIVERY_CONTRACTS: dict[str, Any] = {
    "counts": {"items": 115, "locations": 100, "map_checks": 80, "runtime_locations": 20, "runtime_goals": 1, "route_sentinel_batteries": 5},
    ...
    "repeatability": {"7770016": "repeatable_runtime_proven"},
    "map_overrides": {},
}
