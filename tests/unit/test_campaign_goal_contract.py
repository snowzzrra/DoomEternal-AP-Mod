...
def test_campaign_goal_and_public_locations_are_independent() -> None:
    ...
    assert goal.key == "urdak_mission_complete"
    assert goal.map_key == "e3m3_maykr"
    ...
    assert contract["runtime_map"] == "game/sp/e3m3_maykr/e3m3_maykr"
